...
public class WebviewIndexActivity extends BaseActivity<IWebviewIndexActivity, WebviewIndexPresenter> implements IWebviewIndexActivity {

    private static WebviewIndexActivity instance;

    public static WebviewIndexActivity getInstance() {
        return instance;
    }
    ...
    @Override
    protected WebviewIndexPresenter createPresenter() {
        return new WebviewIndexPresenter();
    }
    ...
    protected int getContentViewId() {
        return R.layout.activity_webview_index;
    }
