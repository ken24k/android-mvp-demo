package com.ken24k.android.mvpdemo.common.statusbar;
...
public class StatusBarUtil {
     ...
     * 修改状态栏颜色，及样式切换
     */
    public static void setStatusBar(Activity activity, String bgColor, String fontColor) {
        setStatusBarColor(activity, Color.parseColor(bgColor));
        if ("#000000".equals(fontColor)) {
